...
export const THEME_TOKENS: ThemeTokenDef[] = [
  ...
  { key: 'widgetPadding', group: 'General', label: 'Widget Padding', type: 'text', default: '10px' },
  ...
  { key: 'inputRadius', group: 'Input Area', label: 'Input Corner Radius', type: 'text', default: '10px' },
  { key: 'inputAreaPadding', group: 'Input Area', label: 'Input Area Padding', type: 'text', default: '0px' },
  { key: 'btnPostRadius', group: 'Input Area', label: 'Post Button Corner Radius', type: 'text', default: '999px' },
  ...
  { key: 'cardPadding', group: 'Comment Card', label: 'Comment Card Padding', type: 'text', default: '12px' },
  ...
  { key: 'replyPadding', group: 'Reply Card', label: 'Reply Card Padding', type: 'text', default: '8px' },
